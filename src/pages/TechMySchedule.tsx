...
export default function TechMySchedule() {
  ...
  // NOTE: Supervisors and admins reach the team-wide schedule via the dedicated
  // "Team" tab in the bottom nav (TechLayout, MapPinned icon). The previous
  // floating FAB on this page was removed 2026-05-03 evening because it
  // duplicated that tab. Don't add it back.
