-- Lock operational cleanup to trusted callers and retain the cron history table
-- used by the System Log cron panel.
...
DECLARE
  ...
  v_trace_days integer := GREATEST(COALESCE(p_trace_days, 7), 3);
