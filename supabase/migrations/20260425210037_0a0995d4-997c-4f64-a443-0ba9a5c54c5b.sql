-- Drop all auto-close-todo triggers
...
-- Drop auto-close functions
DROP FUNCTION IF EXISTS public.auto_close_todos_on_sms() CASCADE;
DROP FUNCTION IF EXISTS public.auto_close_todos_on_call() CASCADE;
DROP FUNCTION IF EXISTS public.auto_close_todos_on_invoice() CASCADE;
DROP FUNCTION IF EXISTS public.auto_close_todos_on_job_note() CASCADE;
DROP FUNCTION IF EXISTS public.auto_close_todos_on_job_scheduled() CASCADE;
DROP FUNCTION IF EXISTS public.auto_close_todos_on_activity_note() CASCADE;

-- Patch merge_customers to remove the todos block (recreate without that section)
