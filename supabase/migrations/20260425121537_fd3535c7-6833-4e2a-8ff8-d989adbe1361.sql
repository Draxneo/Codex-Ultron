-- 1. Patch merge_customers to remove references to dropped tables
...
-- 2. Drop the email-only function
DROP FUNCTION IF EXISTS public.unsnooze_emails();

-- 3. Drop email tables (CASCADE handles dependent objects/policies)
DROP TABLE IF EXISTS public.email_actions CASCADE;
DROP TABLE IF EXISTS public.classification_corrections CASCADE;
DROP TABLE IF EXISTS public.email_drafts CASCADE;
DROP TABLE IF EXISTS public.email_contacts CASCADE;
DROP TABLE IF EXISTS public.email_templates CASCADE;
DROP TABLE IF EXISTS public.email_signatures CASCADE;
DROP TABLE IF EXISTS public.email_snippets CASCADE;
DROP TABLE IF EXISTS public.email_folders CASCADE;
DROP TABLE IF EXISTS public.email_folder_assignments CASCADE;
...
DROP TABLE IF EXISTS public.email_category_overrides CASCADE;
DROP TABLE IF EXISTS public.employee_email_aliases CASCADE;
DROP TABLE IF EXISTS public.vendor_email_domains CASCADE;
DROP TABLE IF EXISTS public.pending_vendor_domains CASCADE;
